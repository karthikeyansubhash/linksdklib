...
public class Sdk {
    ...
    public static class VERSION {
        ...
        public static final String NO_VERSION = "0.teams0.0";
    ...
    public static class VERSION_LEVEL {
        ...
        public static final int FOUR = 4; //LinkForSDK 1.3.1 and WorkpathSDK 1.4
        public static final int SIX = 6; //WorkpathSDK 1.5.0
        public static final int SEVEN = 7; //WorkpathSDK 1.6.0
        public static final int EIGHT = 8; //WorkpathSDK 1.6.1
        public static final int NINE = 9; //WorkpathSDK 1.6.3
//        public static final int FOUR = 4;  //LinkForSDK 1.2.5 (24.7.3)
//        public static final int FIVE = 5;  //LinkForSDK 1.3 (24.8)
    }
