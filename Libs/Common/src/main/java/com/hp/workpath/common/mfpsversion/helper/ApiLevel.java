...
package com.hp.workpath.common.mfpsversion.helper;

import android.content.ContentResolver;
import android.os.Bundle;

import com.hp.workpath.common.Sdk;
import com.hp.workpath.common.mfpsversion.data.MFPSVersionCP;
...
public class ApiLevel {
    ...
    public static int get(final ContentResolver cr) {
        Preconditions.checkNotNull(cr, "Content resolver must be provided to get the SDK services version");
    ...
    /**
     * Retrieve the API level of the MFP Services app without checking the HP Workpath SDK permission.
