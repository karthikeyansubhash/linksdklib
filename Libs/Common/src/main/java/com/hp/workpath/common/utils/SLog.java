...
public class SLog {
    private static final String TAGS_PREFIX = "[SDK]";
    ...
    private static final String PROPERTIES_FOLDER_PATH = DOWNLOAD_FOLDER + File.separator + "SDK";
    private static final String PROPERTIES_FILE_PATH = PROPERTIES_FOLDER_PATH
