...
(function($) {
  ...
  function getVisitedPages() {
    var visited = !!localStorage && localStorage.getItem('visited-pages') || null;
  ...
  function addCurrectPage() {
    ...
    if (!!localStorage) localStorage.setItem('visited-pages', JSON.stringify(pages));
  }
...
(function($) {
  ...
  var config = !!localStorage && JSON.parse(localStorage.getItem('global-navigation') || '{}') || '{}';
  ...
  function updateStore(icon) {
    ...
    if (!!localStorage) localStorage.setItem('global-navigation', JSON.stringify(config));
  }
...
(function($) {
  ...
  function toggleSidebarVisibility(body) {
    var wasClosed = !!localStorage && ('' + localStorage.getItem('navigation-open')) === 'false' || false;
  ...
  ToggleNav.prototype.clickHandler_ = function(event) {
    ...
    if (window.innerWidth >= ToggleNav.BREAKPOINT_) {
      if (!!localStorage) localStorage.setItem('navigation-open', body.hasClass(this.options.activeClass));
    }
  };
...
(function($) {
   ...
   */
  var toastDictionary = !!localStorage && localStorage.getItem(LOCAL_STORAGE_KEY) || null;
  ...
  Toast.prototype.onClickHandler = function() {
    ...
    if (!!localStorage) localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify(toastDictionary));
  };
