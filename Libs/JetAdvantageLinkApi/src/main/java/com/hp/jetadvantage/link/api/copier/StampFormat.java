...
public class StampFormat implements Parcelable {
    ...
    public StampFormat(com.hp.workpath.api.copier.StampFormat workpathStampFormat){
        this.font = workpathStampFormat.font;
        this.startingPage = workpathStampFormat.startingPage;
        this.textColor = workpathStampFormat.textColor;
        this.textSize = workpathStampFormat.textSize;
        this.whiteBackground = workpathStampFormat.whiteBackground;
    }
