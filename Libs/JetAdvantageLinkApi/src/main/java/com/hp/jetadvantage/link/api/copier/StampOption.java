...
public class StampOption implements Parcelable {
    ...
    public StampOption(com.hp.workpath.api.copier.StampOption workpathStampOption) {
        this.format = new StampFormat(workpathStampOption.format);
        this.policyType = StampPolicyType.valueOf(workpathStampOption.policyType.name());
        this.text = workpathStampOption.text;
        this.type = StampType.valueOf(workpathStampOption.type.name());
    }
