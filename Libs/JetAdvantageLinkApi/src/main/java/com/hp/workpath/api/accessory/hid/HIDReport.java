...
/**
 * <p>Report data object to hold accessory data of HID type.</p>
 *
 * @since API 3
 */
public class HIDReport implements Parcelable, Convertor {
    ...
    /**
     * <p>Creates new hid report data.</p>
     *
     * @param hidReportType <p>The type of hid report. There are three types of hid report:-
     * <ul>
    ...
    private HIDReport(Object object) {
        if (object instanceof com.hp.jetadvantage.link.api.accessory.hid.HIDReport) {
            mHidReportType = HIDReportType.valueOf(((com.hp.jetadvantage.link.api.accessory.hid.HIDReport) object).getA().name());
            mData = ((com.hp.jetadvantage.link.api.accessory.hid.HIDReport) object).getB();
        }
    }

    /**
     * <p>Retrieve the supported report type.</p>
     *
     * @return <p>HIDReportType report type.
     * <ul>
     * <li>Return value shouldn't be empty list and should be either any of the boolean values in {@link HIDReportType}.</li>
     * </ul>
     * </p>
     *
     * @since API 3
    ...
    /**
     * <p>Retrieve the report data for creating report.</p>
     *
     * @return <p>report data for creating report.</p>
     *
     * @since API 3
     */
    public byte[] getData() {
