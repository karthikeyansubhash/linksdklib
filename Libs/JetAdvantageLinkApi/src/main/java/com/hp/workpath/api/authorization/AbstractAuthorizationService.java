...
/**
 * <p>AbstractAuthorizationService provides the base implementation for handling authorization features on the Workpath platform.</p>
 * <p>This service provides the ability to pass information about a user and grant the user permissions when the user signs in.</p>
 * <ul>
 * <li>authorizeUser</li>
 * </ul>
 * <p>The authorizeUser() API is called when a user signs in.</p>
 * <p>You can find out information about the currently signed-in user through UserAuthorizationData.</p>
 *
 * @since API 9
 */
