...
/**
 * <p>AuthenticatedUserInfo class represents information about an authenticated user info.</p>
 * <p>This class includes various user attributes such as username, display name, email address, and more.</p>
 *
 * @since API 9
 */
