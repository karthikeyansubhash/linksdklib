...
/**
 * <p>The AuthenticationType enum represents various types of authentication methods supported by the system.</p>
 * <p>Each authentication type includes a description of the method and the required user information.</p>
 *
 * @since API 9
 */
