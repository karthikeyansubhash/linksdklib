...
/**
 * <p>The AuthorizationService class provides methods to interact with the SDK.</p>
 * <p>This includes checking support, setting configurations, and retrieving permissions and sign-in methods.</p>
 *
 * @since API 9
 */
