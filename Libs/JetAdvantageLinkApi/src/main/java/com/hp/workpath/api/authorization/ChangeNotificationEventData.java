...
/**
 * <p>The ChangeNotificationEventData class provides information about change notification events.</p>
 * <p>This class includes the event code and the timestamp of the event.</p>
 *
 * @since API 9
 */
