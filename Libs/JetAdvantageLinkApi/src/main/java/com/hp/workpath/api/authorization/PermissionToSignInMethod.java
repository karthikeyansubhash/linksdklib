...
/**
 * <p>The PermissionToSignInMethod class represents the mapping between a permission and a sign-in method.</p>
 * <p>This class includes the permission ID (UUID) and the sign-in method ID (UUID).</p>
 *
 * @since API 9
 */
