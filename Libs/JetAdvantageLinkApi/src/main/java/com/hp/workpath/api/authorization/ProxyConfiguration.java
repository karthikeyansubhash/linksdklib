...
/**
 * <p>The ProxyConfiguration class manages the proxy settings for the Authorization service.</p>
 * <p>This class includes configurations for guest user permissions, sign-in methods, proxy settings, and more.</p>
 * <p>
 * <p>
 ...
 * <p>Required:</p>
 * <ul>
 * <li>AddNewPermissionToGuestPermissionSet (Boolean): Determines whether new permissions are automatically added to the guest permission set.</li>
 * <li>DefaultSignInMethod (UUID): The default sign-in method used for authentication.</li>
 * <li>EnableSignInChoice (Boolean): Allows users to select an alternate sign-in method if available.</li>
 * <li>EnableChangeNotification (Boolean): Enables notifications for changes in the proxy configuration.</li>
 * </ul>
 * <p>Optional:</p>
 * <ul>
 * <li>GuestPermissionSet (List<{@link Permission}>): A list of permissions granted to unauthenticated (guest) users.</li>
 * <li>GuestUserOverrides: Overrides for guest user settings.</li>
 * <li>PermissionToSignInMethodMap: A map of permissions to specific sign-in methods.</li>
 * </ul>
 */
