...
/**
 * <p>The SignInMethod class represents a sign-in method used for authentication.</p>
 * <p>This class includes the sign-in method ID (UUID), name, and localized name.</p>
 *
 * @since API 9
 */
