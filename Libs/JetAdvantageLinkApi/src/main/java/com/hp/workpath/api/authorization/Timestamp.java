...
/**
 * <p>The Timestamp class represents a timestamp with a time value and an offset.</p>
 * <p>This class includes the time as a string and the offset as a short value.</p>
 *
 * @since API 9
 */
