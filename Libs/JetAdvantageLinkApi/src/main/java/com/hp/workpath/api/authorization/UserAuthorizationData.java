...
/**
 * <p>The UserAuthorizationData class represents the data required for user authorization.</p>
 * <p>This class includes authenticated user information, authentication agent details, user overrides, and a timestamp.</p>
 *
 * @since API 9
 */
