...
/**
 * <p>The UserAuthorizationResult class represents the result of the user authorization process.</p>
 * <p>This class includes the set of permissions granted to the user and any user overrides.</p>
 *
 * @since API 9
 */
