...
package com.hp.workpath.api.config;
 ...
 * If an application is installed as hpk file on a Workpath device, client can access the application configuration data without launching it.</p>
 *
 * @since API 1
 */
@DeviceApi
public final class ConfigService {
    ...
    /**
     * <p>Retrieves configuration data that an application owns.</p>
     *
     ...
     * @exception NullPointerException If context is null or configuration is not provided.
     * @since API 1
     */
    @SuppressWarnings({"unused"})
    @SuppressLint("RestrictedApi")
    ...
    public static abstract class AbstractConfigChangeObserver extends BroadcastReceiver {
         ...
         * @exception NullPointerException NullPointerException Calling a method on a null reference(context) or
         * trying to access a field of a null reference will trigger a NullPointerException.
         * @since API 1
         */
        @SuppressWarnings({"unused"})
        ...
        public void register(@NonNull final Context context) {
            Preconditions.checkNotNull(context, "Context must be provided");
            SLog.d(TAG, "Registering config changed event");
        ...
        public void unregister(@NonNull final Context context) {
            Preconditions.checkNotNull(context, "Context must be provided");
            SLog.d(TAG, "Un-registering config changed event");
