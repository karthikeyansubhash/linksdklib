...
public class CopyAttributes implements Parcelable {
    ...
    /**
     * <p>Watermark Background Pattern for copy</p>
     *
     * @since API 6
     */
    ...
    private CopyAttributes(Parcel in) {
        ...
        if (mVersion >= Sdk.VERSION_LEVEL.SIX) {
            ...
            mOutputBin = null;
            mProgressDialogMode = ProgressDialogMode.OFF;   //For Backward compatibilities
        ...
        if (mVersion >= Sdk.VERSION_LEVEL.SEVEN){
            ...
            mWatermarkDarkness = 1;
            mWatermarkText = null;
            mWatermarkRotate45 = null;
            mWatermarkType = null;
            mWatermarkTextSize = 1;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        Map<String, com.hp.jetadvantage.link.api.copier.StampOption> stampOptionMap = new HashMap<>();

        for(String stampPostionName : mStampOptionMap.keySet()){
            com.hp.jetadvantage.link.api.copier.StampOption stampOption = new com.hp.jetadvantage.link.api.copier.StampOption(mStampOptionMap.get(stampPostionName));
            stampOptionMap.put(stampPostionName, stampOption);
        }
        out.writeMap(stampOptionMap);
    ...
    public static abstract class CopyAttributesBuilder<T extends CopyAttributesBuilder<T>> {
        ...
        StapleOption mStapleOption = StapleOption.DEFAULT;

        PunchMode mPunchMode = PunchMode.DEFAULT;

        FoldMode mFoldMode = FoldMode.DEFAULT;

        Map<String,StampOption> mStampOptionMap = new HashMap<>();
        int mWatermarkDarkness = 1;
         ...
         * @exception NullPointerException if colorMode is null
         * @since API 3
         */
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if duplex is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         *                 document / image.
         * @return this builder for method chaining.
         * @exception NullPointerException if scanSize is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is scanSource is null;
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is copyPreview is null;
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if backgroundCleanup is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if contrastAdjustment is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if darknessAdjustment is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if printSize is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if number of copies is less than or equal to zero
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if collateMode is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if paperSource is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if paperType is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if scaleMode is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if textGraphicsOptimization is null.
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if jobAssemblyMode is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if numberUpMode is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if numberUpDirection is null
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if OutputBin is null
         * @since API 5
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Set progress dialog mode
         *
         * @param progressDialogMode value
         * @return this builder for method chaining.
         * @exception NullPointerException if ProgressDialogMode is null
         * @since API 5
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if captureMode is null.
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets image Shift Reduce To Fit values
         *
         * @param imageShiftReduceToFit value
         * @return this builder for method chaining.
         * @exception NullPointerException if ImageShiftReduceToFit is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if ImageShiftUnits is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets Image Shift Front values
         *
         * @param shifts image front shift
         * @return this builder for method chaining.
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        ...
        /**
         * Sets Image Shift Back values
         *
         * @param shifts image back shift
         * @return this builder for method chaining.
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        ...
        /**
         * Sets Booklet Borders Each Page value
         *
         * @param bookletBordersEachPage value
         * @return this builder for method chaining.
         * @exception NullPointerException if BookletBordersEachPage is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if BookletFinishingOption is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if BookletFormat is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if stapleMode is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if punchMode is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if foldmode is null
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        @SuppressLint("RestrictedApi")
        @NonNull
        public T setStampOption(StampPosition stampPosition, @Nullable final StampOption stampOption) {
         ...
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if amount of transparency is less than or equal to zero
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if amount of textSize is less than or equal to zero
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is watermarkFirstPageOnly is null;
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if amount of darkness is less than or equal to zero
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is watermarkRotate45 is null;
         * @since API 6
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets the watermark type param.
         *
         * @param watermarkType Scan preview flag value
         * @return this builder for method chaining
         * @exception NullPointerException is watermarkType is null;
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is watermarkMessageType is null;
         * @since API 6
         */
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is watermarkBackgroundPattern is null;
         * @since API 6
         */
        ...
        void validate(final CopyAttributesCaps caps) throws CapabilitiesExceededException {
            ...
            if (!caps.getScanDuplexList().contains(mScanDuplex)) {
                throw new CapabilitiesExceededException("Supplied scan duplex not supported");
            }
            ...
            if (!caps.getScanSourceList().contains(mScanSource)) {
                throw new CapabilitiesExceededException("Supplied scan source not supported");
            }
            ...
            if (!caps.getBackgroundCleanupList().contains(mBackgroundCleanup)) {
                throw new CapabilitiesExceededException("Supplied background сleanup not supported");
            }
            ...
            if (!caps.getPrintDuplexList().contains(mPrintDuplex)) {
                throw new CapabilitiesExceededException("Supplied print duplex not supported");
            }

            if (!caps.getPrintSizeList().contains(mPrintSize)) {
                throw new CapabilitiesExceededException("Supplied print size not supported");
            }
            ...
            if (!caps.getCollateModeList().contains(mCollateMode)) {
                throw new CapabilitiesExceededException("Supplied collate mode is not supported");
            }

            if (!caps.getPaperSourceList().contains(mPaperSource)) {
                throw new CapabilitiesExceededException("Supplied paper source is not supported");
            }

            if (!caps.getPaperTypeList().contains(mPaperType)) {
                throw new CapabilitiesExceededException("Supplied paper type is not supported");
            }

            if (!caps.getScaleModeList().contains(mScaleMode)) {
                throw new CapabilitiesExceededException("Supplied scale mode is not supported");
            }
            ...
            if (!caps.getTextGraphicsOptimizationList().contains(mTextGraphicsOptimization)) {
                throw new CapabilitiesExceededException("Supplied text/graphics optimization not supported");
            }
            ...
            if (!caps.getJobExecutionModeList().contains(mJobExecutionMode)) {
                throw new CapabilitiesExceededException("Supplied job execution mode not supported");
            }

            if (!caps.getNumberUpModeList().contains(mNumberUpMode)) {
                throw new CapabilitiesExceededException("Supplied number up mode not supported");
            }

            if (mNumberUpMode != NumberUpMode.DEFAULT) {
            ...
            if (!caps.getOutputBinList().contains(mOutputBin)) {
                throw new CapabilitiesExceededException("Supplied output bin is not supported");
            }

            if (!caps.getProgressDialogModeList().contains(mProgressDialogMode)) {
                throw new CapabilitiesExceededException("Supplied progress dialog mode is not supported");
            }
            if (!caps.getWatermarkTypeList().contains(mWatermarkType)) {
                throw new CapabilitiesExceededException("Supplied watermark type value not supported");
            }
            if (!(mWatermarkType == WatermarkType.DEFAULT || mWatermarkType == WatermarkType.NONE)){
                if (mWatermarkType == WatermarkType.TEXT) {
                    ...
                    if (!caps.getWatermarkTextColorList().contains(mWatermarkTextColor)) {
                        throw new CapabilitiesExceededException("Supplied watermark text color value not supported");
                    }
                    ...
                    if (!caps.getWatermarkBackgroundPatternList().contains(mWatermarkBackgroundPattern)) {
                        throw new CapabilitiesExceededException("Supplied watermark background pattern value not supported");
                    }
                    ...
                    if (!caps.getWatermarkBackgroundColorList().contains(mWatermarkBackgroundColor)) {
                        throw new CapabilitiesExceededException("Supplied watermark background color value not supported");
                    }
                    if (!caps.getWatermarkRotate45List().contains(mWatermarkRotate45)) {
                        throw new CapabilitiesExceededException("Supplied watermark rotation value not supported");
                    }
                }
                if (!caps.getWatermarkTextSizeList().contains(mWatermarkTextSize)) {
                    throw new CapabilitiesExceededException("Supplied watermark TextSize value is not supported");
                }
                ...
                if (!caps.getWatermarkOnlyFirstPageList().contains(mWatermarkOnlyFirstPage)) {
                    throw new CapabilitiesExceededException("Supplied watermark OnlyFirstPage value not supported");
                }
                ...
                if (!caps.getWatermarkMessageTypeList().contains(mWatermarkMessageType)) {
                    throw new CapabilitiesExceededException("Supplied watermark message type value not supported");
                }
                ...
                if (!caps.getWatermarkFontList().contains(mWatermarkFont)) {
                    throw new CapabilitiesExceededException("Supplied watermark font value not supported");
                }
            }
            ...
            if (!caps.getImageShiftReduceToFitList().contains(mImageShiftReduceToFit)) {
                throw new CapabilitiesExceededException("Supplied ImageShiftReduceToFit is not supported");
            }

            if (!caps.getImageShiftUnitsList().contains(mImageShiftUnits)) {
                throw new CapabilitiesExceededException("Supplied ImageShiftUnits is not supported");
            }
            ...
            if (!caps.getBookletBordersEachPageList().contains(mBookletBordersEachPage)) {
                throw new CapabilitiesExceededException("Supplied BookletBordersEachPage is not supported");
            }

            if (!caps.getBookletFinishingOptionList().contains(mBookletFinishingOption)) {
                throw new CapabilitiesExceededException("Supplied BookletFinishingOption is not supported");
            }

            if (!caps.getBookletFormatList().contains(mBookletFormat)) {
                throw new CapabilitiesExceededException("Supplied BookletFormat is not supported");
            }

            if (!caps.getStapleOptionList().contains(mStapleOption)) {
                throw new CapabilitiesExceededException("Supplied staple mode is not supported");
            }

            if (!caps.getPunchModeList().contains(mPunchMode)) {
                throw new CapabilitiesExceededException("Supplied punch mode is not supported");
            }

            if (!caps.getFoldModeList().contains(mFoldMode)) {
                throw new CapabilitiesExceededException("Supplied fold mode is not supported");
            }
            ...
            for(String stampPositionName : mStampOptionMap.keySet()){
                if (!caps.getStampPositionList().contains(StampPosition.valueOf(stampPositionName))) {
                    throw new CapabilitiesExceededException("Supplied stamp option is not supported");
                }
    ...
    public static class CopyBuilder extends CopyAttributesBuilder<CopyBuilder> {
         ...
         *
         * @param caps The copy capabilities supported by the printer.
         *
         * @return a CopyAttributes object containing all of the attributes supported by the device.
         *
    ...
    public static class StoreCopyBuilder extends CopyAttributesBuilder<StoreCopyBuilder> {
         ...
         *
         * @param jobName job name for copy job.
         * <p>
         * <ul>
         * <li>There is no minimum & maximum length.</li>
         * <li>Instance variable assigned as empty string for input.</li>
         * <li>Instance variable assigned as NULL for null input.</li>
         * <li>Expected input - String value.</li>
         * </ul>
         * </p>
         *
         * @return CopyAttributes builder for method chaining.
         *
         * @since API 3
         */
        @SuppressWarnings({"unused", "unchecked"})
        ...
        /**
         * Sets folder name for store job supported by current printer.
         *
         * @param folderName folder name for copy job.
         * <p>
         * <ul>
         * <li>There is no minimum & maximum length.</li>
        ...
        /**
         * Sets job credentials to protect stored job supported by the current printer.
         *
         * @param jobCredentialsAttributes credentials of copy job.
         *
         * @return CopyAttributes builder for method chaining.
         *
         * @exception NullPointerException Calling a method on a null reference(jobCredentialsAttributes) or
        ...
        /**
         * Sets on power cycle retention mode for stored job supported by the printer.
         *
         * @param retentionMode store job retention mode on power cycle from {@link CopyAttributes.RetentionMode}.
         *
         * @return CopyAttributes builder for method chaining.
         *
         * @exception NullPointerException Calling a method on a null reference(retentionMode) or
         * trying to access a field of a null reference will trigger a NullPointerException.
         *
         * @since API 3
         */
        ...
        /**
         * Sets on release retention mode for stored jobs.
         *
         * @param retentionMode store job retention mode on release job from {@link CopyAttributes.RetentionMode}.
         *
         * @return CopyAttributes builder for method chaining.
         *
         * @exception NullPointerException Calling a method on a null reference(retentionMode) or
         ...
         * @param caps The copy capabilities supported by the printer.
         *
         * @return a CopyAttributes object containing all of the attributes.
         *
         * @exception CapabilitiesExceededException if caps does not contain the set attribute value.
         *
         * @exception IllegalArgumentException      if stored job folder name is null or missing fields.
         *
         * @since API 3
         */
        @Override
