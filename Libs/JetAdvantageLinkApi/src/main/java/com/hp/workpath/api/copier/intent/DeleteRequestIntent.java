...
public class DeleteRequestIntent extends BaseCopyRequestIntent<DeleteRequestIntent.IntentParams> {
    ...
    public static class IntentParams extends BaseCopyRequestIntent.IntentParams {
         ...
         */
        public IntentParams(final com.hp.workpath.api.copier.JobCredentialsAttributes jobCredentialsAttributes, final String reqId,
        ...
        public com.hp.workpath.api.copier.JobCredentialsAttributes getJobCredentialsAttributes() {
            Parcel parcelForJobCredentials = Parcel.obtain();
            if (mJobCredentialsAttributes != null) {
                mJobCredentialsAttributes.writeToParcel(parcelForJobCredentials, 0);
                parcelForJobCredentials.setDataPosition(0);
                return com.hp.workpath.api.copier.JobCredentialsAttributes.CREATOR.createFromParcel(parcelForJobCredentials);
            } else {
                return null;
            }
        }
    ...
    public static IntentParams getIntentParams(final Bundle bundle) {
        ...
        com.hp.workpath.api.copier.JobCredentialsAttributes jobCredentialsAttributes = null;
        String rid = null;
