...
public class ReleaseRequestIntent extends BaseCopyRequestIntent<ReleaseRequestIntent.IntentParams> {
    ...
    public static class IntentParams extends BaseCopyRequestIntent.IntentParams {
         ...
         */
        public IntentParams(final com.hp.workpath.api.copier.StoredJobAttributes attributes, final String reqId, final String packageName,
            ...
            Parcel parcelForStore = Parcel.obtain();
            if (attributes != null) {
                attributes.writeToParcel(parcelForStore, 0);
                parcelForStore.setDataPosition(0);
                mStoredJobAttributes = StoredJobAttributes.CREATOR.createFromParcel(parcelForStore);
            } else {
                mStoredJobAttributes = null;
            }
        }

        public com.hp.workpath.api.copier.StoredJobAttributes getStoredJobAttributes() {
            Parcel parcelForStore = Parcel.obtain();
            if (mStoredJobAttributes != null) {
                mStoredJobAttributes.writeToParcel(parcelForStore, 0);
                parcelForStore.setDataPosition(0);
                return com.hp.workpath.api.copier.StoredJobAttributes.CREATOR.createFromParcel(parcelForStore);
            } else {
                return null;
            }
        }
    ...
    public static IntentParams getIntentParams(final Bundle bundle) {
        ...
        com.hp.workpath.api.copier.StoredJobAttributes storedJobAttributes = null;
        String rid = null;
