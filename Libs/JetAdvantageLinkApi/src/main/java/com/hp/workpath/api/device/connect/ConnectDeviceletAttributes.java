...
public class ConnectDeviceletAttributes implements Parcelable {
    ...
    /**
     * Indicates whether a connect UI progress should appear prior to sending to the printer.
     *
     * @return True, if a connect UI progress will be shown. Otherwise, false.
     * @hide not open API
     */
    ...
    /**
     * @return of the version of attributes
     * @hide not open API
     */
    @SuppressWarnings({"unused"})
    ...
    public static class Builder {
        ...
        /**
         * <p>Sets the option to use built-in UI progress dialog while discoverying.</p>
         *
         * @param visibility If TRUE, built-in UI progress dialog shows.
         ...
         * @since API 1
         */
        public ConnectDeviceletAttributes build() {
