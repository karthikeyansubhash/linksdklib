...
@MobileApi
public class DiscoveryStopRequestIntent extends Intent implements ISpsIntentWrapper<DiscoveryStopRequestIntent.IntentParams> {
    /**
     * Action to launch the discovery.
     */
    public static final String ACTION = "com.hp.jetadvantage.link.intent.action.STOP_DISCOVERY";
    private static final String EXTRA_PACKAGE_NAME = "packageName";

    /**
     * Constructor for ScanToRequestIntent.
     */
    public DiscoveryStopRequestIntent() {
        super(ACTION);
    }
