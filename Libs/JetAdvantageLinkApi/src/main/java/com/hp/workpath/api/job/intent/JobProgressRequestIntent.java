...
package com.hp.workpath.api.job.intent;
...
public final class JobProgressRequestIntent extends Intent implements ISpsIntentWrapper<JobProgressRequestIntent.Params> {
    ...
    public static class Params {
        ...
        public Params(final String jobId, final com.hp.workpath.api.job.JobletAttributes taskAttributes,
            ...
            if (taskAttributes != null) {
                ...
                mTaskAttributes = JobletAttributes.CREATOR.createFromParcel(parcelForTask);
            } else {
                mTaskAttributes = null;
            }
    ...
    public static Params getIntentParams(final Intent intent) {
        ...
        String jobId = "";
        com.hp.workpath.api.job.JobletAttributes taskAttributes = null;
