...
public class NetworkCredentialsAttributes implements Parcelable {
    ...
    public static class Builder {
         ...
         * <p>
         * <ul>
         * <li>There is no minimum length. The set value must be non-empty and not exceed 128 characters length. And password value must be set as well.</li>
         ...
         * <p>
         * <ul>
         * <li>There is no minimum length. The set value must not exceed 128 characters length and username value must be set as well.</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not empty.</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not null.</li>
         * <li>Expected input - String value</li>
         * </ul>
         ...
         * <p>
         * <ul>
         * <li>There is no minimum length. The set value must not exceed 4092 characters length..</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not empty.</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not null.</li>
         * <li>Expected input - String value</li>
         * </ul>
