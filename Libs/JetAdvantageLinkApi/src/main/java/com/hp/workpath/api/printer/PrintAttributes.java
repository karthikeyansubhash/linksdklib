...
public class PrintAttributes implements Parcelable {
    ...
    public static abstract class PrintCommonAttributesBuilder<T extends PrintCommonAttributesBuilder<T>> {
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if autoFit is null
         * @since API 1
         */
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if paperSize is null
         * @since API 1
         */
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if documentFormat is null
         * @since API 1
         */
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets job name for the job
         *
         * @param jobName Name for the job
         * <p>
         * <ul>
         * <li>Ensures that the argument string characters length is greater than zero.</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not empty.</li>
         * <li>Ensures that an string reference passed as a parameter to the calling method is not null.</li>
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if printQuality is null
         * @since API 5
         */
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets start page of page-ranges for print.
         *
         * @param startPageRanges The start page of page-ranges to be produced.
         * <p>value a numeric int value
         * <ul>
         * <li>Ensures that the argument numeric value is non-negative.</li>
         * <li>If the startPageRanges value is 0, then there is no range value and all the pages of the file will be printed.</li>
         * </ul>
         * </p>
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if startPageRanges is less than zero
         * @since API 5
         */
        @SuppressLint("RestrictedApi")
        ...
        /**
         * Sets end page of page-ranges for print.
         *
         * @param endPageRanges The end page of page-ranges to be produced.
         * <p>value a numeric int value
         * <ul>
         * <li>Ensures that the argument numeric value is non-negative.</li>
         * <li>If the endPageRanges value is 0, then there is no range value and all the pages of the file will be printed.</li>
         * </ul>
         * </p>
         * @return this builder for method chaining.
         * @exception IllegalArgumentException if endPageRanges is less than zero
         * @since API 5
         */
        @SuppressLint("RestrictedApi")
         ...
         * </p>
         * @return this builder for method chaining.
         * @exception NullPointerException if finishingsList is null
         * @since API 5
         */
        @SuppressLint("RestrictedApi")
    ...
    public static class PrintFromStorageBuilder extends PrintCommonAttributesBuilder<PrintFromStorageBuilder> {
         ...
         * <p>
         * <ul>
         * <li>Ensures that an Uri reference passed as a parameter to the calling method is not empty.</li>
         * <li>Ensures that an Uri reference passed as a parameter to the calling method is not null.</li>
         * <li>The file must reside on publicly accessible folder.</li>
         * </ul>
         * </p>
         * @since API 1
         */
         ...
         * @exception NullPointerException if attrs is null
         ...
         * @exception IllegalArgumentException      if the fileUri cannot be found or points to wrong location
         * @since API 1
         */
        @Override
    ...
    public static class PrintFromHttpBuilder extends PrintCommonAttributesBuilder<PrintFromHttpBuilder> {
         ...
         * </ul>
         * </p>
         * @return this builder for method chaining {@link PrintFromHttpBuilder}.
         * @since API 1
         */
    ...
    public static class PrintFromStreamBuilder extends PrintCommonAttributesBuilder<PrintFromStreamBuilder> {
         ...
         * <br>
         *
         * @param inputStream Instantiates the constructor with InputStream
         * <p>
         * <ul>
         * <li>Ensures that an object reference passed as a parameter to the calling method is not null.</li>
         * </ul>
