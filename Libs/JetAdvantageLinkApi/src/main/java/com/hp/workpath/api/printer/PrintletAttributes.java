...
public class PrintletAttributes implements Parcelable {
     ...
     */
    @SuppressWarnings({"unused"})
    public boolean getBackgroundJob() { return mBackgroundJob; }
    ...
    public static class Builder {
        ...
        /**
         * Sets whether or not print job should be running on the background.
         *
         * @param backgroundJob boolean  true to enable background print job, false if not.
         * @return this builder for method chaining.
         * @since API 7
         */
        @SuppressWarnings({"unused"})
