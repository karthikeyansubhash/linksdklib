...
public class StatusInfo implements Parcelable {
    ...
    /**
     * Retrieves printer status, whether printer is ready to new jobs
     *
    ...
    /**
     * Retrieves list of printer status reasons
     *
     * @return <p> List of details status reasons
     * <ul>
     * <li>Return can't be empty and should be either any of the StatusReason from {@link StatusInfo.StatusReason}</li>
     * </ul>
     * </p>
     * @since API 1
     */
