...
public class TrayInfo implements Parcelable {
     ...
     *
     * @return paper size loaded in tray
     * @since API 1
     */
    @SuppressWarnings("unused")
    @Keep
     ...
     *
     * @return paper type loaded in tray
     * @since API 1
     */
    @SuppressWarnings("unused")
    @Keep
     ...
     *
     * @return <p>current capacity of the tray in percentage
     * <ul>
