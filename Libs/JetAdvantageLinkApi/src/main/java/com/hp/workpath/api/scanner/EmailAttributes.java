...
public final class EmailAttributes implements Parcelable {
    ...
    public static class Builder {
         ...
         * @exception NullPointerException if emailAddress is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if emailAddresses is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if emailAddress or name is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
