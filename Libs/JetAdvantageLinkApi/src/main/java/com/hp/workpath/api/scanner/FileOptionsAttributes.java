...
public final class FileOptionsAttributes implements Parcelable {
    ...
    public static class Builder {
         ...
         * @exception NullPointerException if pdfEncryptionPassword is null
         * @since API 1
         */
         ...
         * @return this builder for method chaining
         * @exception NullPointerException if ocrLanguage is null
         * @since API 1
         */
        @SuppressWarnings("unused")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException if pdfCompressionMode is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException if tiffCompressionMode is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException if xpsCompressionMode is null
         * @since API 1
         */
        @SuppressWarnings("unused")
        @SuppressLint("RestrictedApi")
