...
import com.hp.workpath.common.utils.FileUtility;
...
public final class ScanAttributes implements Parcelable {
    ...
    public static abstract class ScanAttributesBuilder<T extends ScanAttributesBuilder<T>> {
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if docFormat is null
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if res is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining
         * @exception NullPointerException is scanPreview is null;
         * @deviceOnly
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        ...
        /**
         * Sets the credentials for admin user name and password which configured on a printer to be allowed to run scanning
         *
         * @param userName privileged user name
         * @param password privileged user password
         * @return this builder for method chaining
         * @exception NullPointerException if username or password are null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if blankImageRemovalMode is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if colorDropoutMode is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @param cropMode mode
         * @return this builder for method chaining.
         * @exception NullPointerException if cropMode is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if outputQuality is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if transmissionMode is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if fileOptionsAttributes is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if sharpnessAdjustment is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if mediaWeightAdjustment is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if textPhotoOptimization is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if mediaSource is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
         ...
         * @return this builder for method chaining.
         * @exception NullPointerException if misfeedDetectionMode is null.
         * @since API 1
         */
        @SuppressWarnings({"unused", "unchecked"})
        @SuppressLint("RestrictedApi")
        ...
        /**
         * When SplitAttachmentByPages is enabled, scanned documentation is split by 'MaxPagesPerAttachment' value
         *
    ...
    public static class EmailBuilder extends ScanAttributesBuilder<EmailBuilder> {
        ...
        void validate(ScanAttributesCaps caps) throws CapabilitiesExceededException {
            ...
            if (mSmtpAttributes != null && mEmailAttributes.mFrom == null) {
                throw new CapabilitiesExceededException("Email FROM address value must be provided.");
            }
