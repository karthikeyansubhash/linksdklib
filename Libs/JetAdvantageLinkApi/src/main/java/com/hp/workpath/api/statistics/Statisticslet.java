...
public class Statisticslet {
    ...
    public static final class Param {
        ...
        /**
         * Param to pass package name to Statisticslet
         *
    ...
    /**
     * Statisticslet providers authority
     *
     * @hide for internal communication
     * @since API 5
     */
    ...
    /**
     * Path for general Statisticslet content provider calls
     *
     * @hide for internal communication
     * @since API 5
     */
    ...
    /**
     * Statisticslet providers scheme
     *
     * @hide for internal communication
     * @since API 5
     */
    ...
    /**
     * Statisticslet providers content uri
     *
     * @hide for internal communication
     * @since API 5
     */
